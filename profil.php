        ...
        <div class="row">
            <div class="col-sm-12">
                <section class="panel">
                    ...
                    <tbody>
                    <?php 
                     $sql= "SELECT  `STUD_NO`, CONCAT(`STUD_FNAME`,' ', `STUD_LNAME`) AS FULLNAME,`STUD_COURSE`,`STUD_STATUS`FROM `r_stud_profile`WHERE STUD_STATUS='REGULAR'";

                    $query = mysqli_query($db, $sql);
                    
                    { while($stud_row=mysql_fetch_array($query)) { ?>
                    <tr><?php echo $stud_row['Stud_NO']; ?></tr>
                    <tr></tr>
                    <tr></tr>
                    <tr></tr>
                    <tr></tr>
